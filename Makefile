...
cli:
	GOOS=darwin go build -o build/fantasygoldportal-mac github.com/fantasygold/fantasygoldportal/cli/fantasygoldportal
	GOOS=linux go build -o build/fantasygoldportal-linux github.com/fantasygold/fantasygoldportal/cli/fantasygoldportal
